        ...
        <ul class="navbar-nav mr-0">
            ...
            <li class='nav-item dropdown'><a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" id='navbarDropdown' aria-haspopup="true" aria-expanded="false" role="button">ワーホリ</a>
                <div class='dropdown-menu' aria-labelledby="navbarDropdown">
                    <a class='dropdown-item' href="/blog/category/working-holiday/canada">カナダ</a>
                    <div class='dropdown-divider'></div>
                    <a class='dropdown-item' href="/blog/category/working-holiday/australia">オーストラリア</a>
                </div>
            </li>
            <li class='nav-item'><a class="nav-link" href="/blog/category/goods">モノ</a></li>
        </ul>
    </div>
</nav>